...
# get bandana/load
  ...
  # map.connect '', :controller => 'bandana', :action => 'index', :conditions => {:method => :get}
  # map.connect '', :controller => 'bandana', :action => 'loads', :conditions => {:method => :get}
  
  map.connect 'bandana/show', :controller => 'bandana',
              :action => 'show',
              :conditions => {:method => :get}

  # map.load_node "/bandana/load_node", :controller => "bandana", :action => "load_node", :conditions => {:method => :get}
  map.save_node "/bandana/save_node", :controller => "bandana", :action => "save_node", :conditions => {:method => :get}
  map.screen_log "/bandana/screen_log", :controller => "bandana", :action => "screen_log", :conditions => {:method => :post}
  # map.connect '/load_node', :controller => 'bandana',:action => 'load_node', :conditions => {:method => :get}
  map.connect "bandana/load_node", :controller => "bandana", :action => "load_node", :conditions => {:method => :post}
  map.connect 'bandana/:filename', :controller => 'bandana',
